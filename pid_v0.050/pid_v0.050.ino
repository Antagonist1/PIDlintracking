...
void loop() {
  ...
  String pattern = getPattern("WhiteLine");00110
 */
  Bend();
}
void Bend() {
  ...
  if (!turning && (pattern == "00011111" || pattern == "00111111" || pattern == "00011011" || pattern == "01100110" || pattern == "11000011" || pattern == "01000010" || pattern == "10000001" || pattern == "00001011" || pattern == "00001001" || pattern == "01101111" || pattern == "01100001" || pattern == "00110001" || pattern == "01100011" || pattern == "11000001" || pattern == "01000111" || pattern == "00100111" || pattern == "00110011" || pattern == "11000111" || pattern == "10001111" || pattern == "00111110")) {  // sağa doksan
    turning = true;
  ...
  if (turning) {
    if (pattern == "00011100" || pattern == "00011000") {
    ...
    if (pattern == "00111000" || pattern == "00011000") {
      for (int i = 0; i <= 70; i += 10) {
        motorSetSpeed(-i, i);  // Negatif hızlarla geriye doğru azaltma
        delay(3);              // Her adımda biraz bekle
      }
